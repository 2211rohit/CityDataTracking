...
export default class Home extends React.Component {
  ...
  handleSubmit(e) {
    e.preventDefault();
    axios.get(
      "http://localhost:5000/show_datas?page=" + this.state.pages, {
        headers : {limit: this.state.limit}
      })
      .then(response => {
  ...
  apiCall = (currentPage = 1) => {
    axios
      .post("http://localhost:5000/pagination?page=" + currentPage, 
      )
      .then(response => {
        console.log(response.data);
        this.setState({
          flag: true,
          data: response.data.data,
          total_pages: Math.ceil(response.data.total_city / 10)
        });
      })
      .catch(function(error) {
        console.log(error);
            ...
            <div className="row">
              ...
              <div className="col-8">
                            ...
                            <div className="modal-dialog" role="document">
                              <div className="modal-content">
                                ...
                                <form onSubmit={e => this.edit_city(e)}>
                                  ...
                                  <div className="col-8">
                                  <h3 className="modal-title text-primary" >Edit {row.city}</h3>
                ...
                <form onSubmit={e => this.handleSubmit(e)}>
                  <div className="form-group">
                    <label htmlFor="inputAddress">Enter No of Rows per Page</label>
                    <input
                      type="text"
